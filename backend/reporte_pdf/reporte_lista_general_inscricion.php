...
class PdfListaInscricionGeneral extends FPDF{
    ...
    function generarPdf(){
        ...
        $this->Cell(0,10,"LISTADO DE INSCRITOS",0,0,"C");
...
// $pdf->Cell(0,10,"LISTADO DE INSCRITOS",0,0,"C");
...
// $pdf->Cell(30,10,'6to',1,0,'C');
// $pdf->Cell(30,10,'A',1,0,'C');
