...
class PdfListadoPermiso extends FPDF{
    ...
    function generarPdf(){
        ...
        $this->Cell(0,10,"PERMISO DEL TRABAJADOR",0,0,"C");
        ...
        if($this->datosPdf[0]["permiso_trabajador_tipo"]==="PN"){
            ...
            $this->SetX(40);
            $this->Cell(21,10,"Cedula",1,0,"C");
            $this->Cell(31,10,"Nombre permiso",1,0,"C");
            $this->Cell(20,10,"Desde",1,0,"C");
            $this->Cell(20,10,"Hasta",1,0,"C");
            ...
            $this->Cell(21,10,"Cedula",1,0,"C");
            $this->Cell(31,10,"Nombre permiso",1,0,"C");
            $this->Cell(35,10,"Fecha de solicitud",1,0,"C");
            $this->Cell(22,10,"Estatus",1,0,"C");
            $this->Cell(30,10,"Tipo de permiso",1,0,"C");
        }
        $contador=0;
        while($contador<count($this->datosPdf)){
           ...
           if($this->datosPdf[$contador]["permiso_trabajador_tipo"]==="PN"){
                ...
                $this->Cell(30,10,(($this->datosPdf[$contador]["estatu_remunerado"]==="1")?"SI":"NO"),1,0,"C");
                $this->Cell(30,10,(($this->datosPdf[$contador]["estatu_dias_aviles"]==="1")?"SI":"NO"),1,0,"C");
                $this->Cell(22,10,$estadoPermiso,1,0,"C");
                $this->Cell(30,10,"Permiso normal",1,0,"C");
           }
           else{
            $this->SetX(70);
    ...
    function generarPdf2(){
        ...
        if($this->datosPdf[0]["permiso_trabajador_tipo"]==="PN"){
            ...
            $this->SetX(10);
            $this->Cell(21,10,"Cedula",1,0,"C");
            $this->Cell(31,10,"Nombre",1,0,"C");
            $this->Cell(31,10,"Apellido",1,0,"C");
            $this->Cell(31,10,"Nombre permiso",1,0,"C");
            $this->Cell(20,10,"Desde",1,0,"C");
            $this->Cell(20,10,"Hasta",1,0,"C");
            $this->Cell(30,10,"Remunerado",1,0,"C");
        ...
        while($contador<count($this->datosPdf)){
           ...
           if($this->datosPdf[$contador]["permiso_trabajador_tipo"]==="PN"){
                ...
                $this->Cell(31,10,utf8_decode($this->datosPdf[$contador]["apellidos"]),1,0,"C");
                $this->Cell(31,10,utf8_decode($this->datosPdf[$contador]["nombre_permiso"]),1,0,"C");
                $this->Cell(20,10,$fechaDesde,1,0,"C");
                $this->Cell(20,10,$fechaHasta,1,0,"C");
                $this->Cell(30,10,(($this->datosPdf[$contador]["estatu_remunerado"]==="1")?"SI":"NO"),1,0,"C");
            ...
            $this->Cell(35,10,$fecha,1,0,"C");
            $this->Cell(22,10,$estadoPermiso,1,0,"C");
            $this->Cell(30,10,"Permiso retiro",1,0,"C");
           }
            $contador++;
        }
