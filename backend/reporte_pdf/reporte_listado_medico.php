...
class PdfListaMedico extends FPDF{
    ...
    function generarPdf(){
        ...
        $this->Cell(0,10,"REPORTE DE ESPECIALIDAD",0,0,"C");
        
        $this->ln(10);
        
        $this->SetFont("Arial","",10);
        $this->Cell(12,10,"",0,0,"C");
        $this->Cell(23,10,"Nombre Especialidad:",0,0,"R");$this->Cell(30,6,utf8_decode($this->datosPdf[0]["nombre_especialidad"]),'B',0,"C");
        ...
        while($contador<count($this->datosPdf)){
            ...
            $this->Cell(40,10,utf8_decode($this->datosPdf[$contador]["nombre_medico"]." ".$this->datosPdf[$contador]["apellido_medico"]),1,0,'C');
            $contador++;
        }
