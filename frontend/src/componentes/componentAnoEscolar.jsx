...
class ComponentAnoEscolar extends React.Component{
  constructor(){
    super();
  ...
  async consultarTodosLosEstudiantes(){
      return await axios.get(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/configuracion/ano-escolar/consultar-todos`)
  ...
  async UNSAFE_componentWillMount(){
    ...
    async validarAccesoDelModulo(modulo,subModulo){
      ...
      async buscar(a){
        ...
        if(valor!==""){
          await axios.get(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/configuracion/ano-escolar/consultar-patron/${valor}`)
            .then(respuesta=>{
  ...
  render(){
    ...
    const jsx_tabla_encabezado = (
      ...
      const jsx_tabla_body=(
        <tbody>
              {this.state.registros.map((anoEscolar, index)=>{
                if(anoEscolar.vacio){
                  return (
                    <tr key={index}>
                      <td></td>
    ...
    var jsx_AnoEscolar_inicio=(
        <div>
            ...
            <TituloModulo clasesrow="row" clasesColumna="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center" tituloModulo="Módulo Año Escolar"/>
    ...
    return(
        <div className="component_trabajador_inicio">
            <ComponentDashboard
            componente={jsx_AnoEscolar_inicio}
...
export default withRouter(ComponentAnoEscolar)
