...
class ComponentAsistenciaEstudiantesForm extends React.Component{
  ...
  async consultarProfesores(){
    ...
    .then( ({data}) => {
      ...
      if(data.datos.length > 0){
        ...
        for(let profesor of data.datos){
          if(profesor.estatus_profesor === "1"){
            lista_profesores[profesor.id_cedula] = {
              nombres: profesor.nombres, apellidos: profesor.apellidos
            };
          }
        }

        this.setState({hashListaProfesores: lista_profesores})
      }
    })
  ...
  BuscarProfesor(a){
    ...
    let hashListaProfesores = this.state.hashListaProfesores;
    if(hashListaProfesores[a.target.value]){
      this.setState({
        cedula_profesor: a.target.value,
        nombre_profesor: hashListaProfesores[a.target.value].nombres,
        apellido_profesor: hashListaProfesores[a.target.value].apellidos
      });

      this.AsistenciaDeHoy(a.target.value)
    }
  }

  async AsistenciaDeHoy(cedula){
                ...
                <form id="form_trabajador">
                  ...
                  <div className="row mt-3">
                      <div className="col-12 col-ms-12 col-md-12 col-lg-12 col-xl-12 contenedor-titulo-form-asig-aula-prof">
                          <span className="sub-titulo-form-reposo-trabajador">Datos del profesor</span>
                      </div>
                  </div>
                  <div className="row justify-content-center align-items-center">
                      <ComponentFormCampo clasesColumna="col-4 col-sm-4 col-md-4 col-lg-4 col-xl-4"
                        clasesCampo="form-control" obligatorio="si" mensaje={this.state.msj_cedula_profesor[0]}
                        nombreCampo="Cédula:" activo="si" type="text" value={this.state.cedula_profesor}
