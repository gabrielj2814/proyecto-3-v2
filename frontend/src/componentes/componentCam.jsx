...
class ComponentCam extends React.Component{
    ...
    async buscar(a){
        ...
        if(valor!==""){
          await axios.get(`http://localhost:8080/configuracion/cam/consultar-patron/${valor}`)
            .then(respuesta=>{
    ...
    render(){
        ...
        const component=(
            <div>
                ...
                <TituloModulo clasesrow="row" clasesColumna="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center" tituloModulo="Modulo Cam"/>
