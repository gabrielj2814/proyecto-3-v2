...
class ComponentEspecialidad extends React.Component{
    ...
    verficarLista(json_server_response){
      ...
      async buscar(a){
        ...
        if(valor!==""){
          await axios.get(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/configuracion/especialidad/consultar-patron/${valor}`)
            .then(respuesta=>{
        ...
        var jsx_especialidad_inicio=(
            <div>
              {this.state.mensaje.texto!=="" && (this.state.mensaje.estado==="500" || this.state.mensaje.estado==="404") &&
                ...
                <TituloModulo clasesrow="row" clasesColumna="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center" tituloModulo="Módulo de Especialidad"/>
