...
class ComponentBitacora extends React.Component {
    ...
    constructor(){
        ...
        this.state={
            ...
            nombresTablas:{
                ...
                tfecha_incripcion: "Fecha Inscripción",
            ...
            tablas:[
                ...
                { name: "tfecha_incripcion", value:"Fecha Inscripción"},
    ...
    conultarOperaciones(){
        ...
        axios.post(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/transaccion/bitacora/consultar`,json)
        .then(respuesta => {
            // alert("ok")
