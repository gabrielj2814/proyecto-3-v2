        ...
        const jsx=(
            <div>
                ...
                {this.state.listaDeLapsos.map((lapso,index) => {
                    return (
                        <div className="contenedor-lapso" key={index}>
                            <div className='lapso'>
                                <div class="nombre-lapso">Lapso {lapso.nombre_lapso_academico}</div>
                                <div class="estado-lapso"> {(lapso.estatu_lapso_academico==="1")?"No Esta Listo":"Esta Listo"}</div>
                            </div>
                        </div>
                    )
                })}
