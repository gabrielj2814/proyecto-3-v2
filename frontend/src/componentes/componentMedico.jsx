...
import '../css/componentMedico.css'
//componentes
...
class ComponentMedico extends React.Component {
    ...
    async UNSAFE_componentWillMount(){
        ...
        if(acessoModulo){
            var json_server_response=await this.consultarTodosMedicos();
    ...
    actualizarElementoTabla(a){
        var input=a.target;
        this.props.history.push("/dashboard/configuracion/medico/actualizar/"+input.id);
    }
    
    consultarElementoTabla(a){
        let input=a.target;
        //alert("Consultar -> "+input.id);
        this.props.history.push("/dashboard/configuracion/medico/consultar/"+input.id);
    }
    ...
    async buscar(a){
        ...
        if(valor!==""){
            await axios.get(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/configuracion/medico/consultar-patron/${valor}`)
            .then(respuesta=>{
                respuesta_servidor=respuesta.data
                console.log(respuesta_servidor)
                this.setState({registros:respuesta_servidor.medicos})
            })
            .catch(error=>{
                console.log(error)
    ...
    async escribir_codigo(a){
        ...
        if(valor!==""){
            await axios.get(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/configuracion/medico/consultar-patron/${valor}`)
                ...
                respuesta_servidor=respuesta.data
                console.log(respuesta_servidor)
                this.setState({datoDeBusqueda:valor,registros:respuesta_servidor.medicos})
            })
            .catch(error=>{
                console.log(error)
                alert("error en el servidor")
	...
	render(){
        ...
        */
		...
		return(
			<div className="component_medico_inicio">
               <ComponentDashboard
                componente={jsx_medico_inicio}
...
export default withRouter(ComponentMedico)