...
class ComponentEnfermedades extends React.Component{
    constructor(){
        super();
        ...
        this.consultarTodosLasEnfermedades = this.consultarTodosLasEnfermedades.bind(this)
    ...
    async consultarTodosLasEnfermedades(){
        return await axios.get(`http://${servidor.ipServidor}:${servidor.servidorNode.puerto}/configuracion/enfermedad/consultar-todos`)
    ...
    async UNSAFE_componentWillMount(){
      ...
      if(acessoModulo){
          var json_server_response=await this.consultarTodosLasEnfermedades();
    ...
    render(){
      ...
      const jsx_tabla_encabezado = (
        ...
        const jsx_tabla_body=(
          <tbody>
                {this.state.registros.map((enfermedad, index)=>{
                    
                    if(enfermedad.vacio) return '';
                    return(
                        <tr key={index}>
      ...
      var jsx_enfermedad_inicio=(
          <div>
              ...
              <TituloModulo clasesrow="row" clasesColumna="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 text-center" tituloModulo="Módulo Enfermedades"/>
...
export default withRouter(ComponentEnfermedades)
